...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FCMPlayMontageAndWaitForEventDelegate, FGameplayTag, EventTag, FGameplayEventData, EventData);
 ...
 */
UCLASS()
class CRIMSONMIRROR_API UCMTaskPlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()

public:
	// Constructor and overrides
	UCMTaskPlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	UPROPERTY(BlueprintAssignable)
		FCMPlayMontageAndWaitForEventDelegate OnCompleted;

	/** The montage started blending out */
	UPROPERTY(BlueprintAssignable)
		FCMPlayMontageAndWaitForEventDelegate OnBlendOut;

	/** The montage was interrupted */
	UPROPERTY(BlueprintAssignable)
		FCMPlayMontageAndWaitForEventDelegate OnInterrupted;

	/** The ability task was explicitly cancelled by another ability */
	UPROPERTY(BlueprintAssignable)
		FCMPlayMontageAndWaitForEventDelegate OnCancelled;

	/** One of the triggering gameplay events happened */
	UPROPERTY(BlueprintAssignable)
		FCMPlayMontageAndWaitForEventDelegate EventReceived;
	...
	static UCMTaskPlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
...
private:
	...
	UCMAbilitySystemComponent* GetTargetASC();
